...
OUTPUT_CSV_PATH = Path("CAMEO_hurriyet_Eng_2.csv")
TOPICS_REPORT_PATH = Path("CAMEO_hurriyet_Eng_2.txt")
...
You MUST select sub‑codes ONLY from the list below, and ONLY from the
category chosen in STEP 1.
